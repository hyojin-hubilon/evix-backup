...
const termsGenerator = () => {
    return [
        {
            title: 'Last Revised: November 2022', description: ''
        },
        {
            title: '', description: `These Terms and Conditions together with our Privacy Notice govern your
...
const PrivacyPolicy: React.FC<Props> = ({ isOpen, handleOpen }) => {
