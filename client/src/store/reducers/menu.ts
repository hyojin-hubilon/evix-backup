...
const initialState = {
	...
	onboarding: false, //온보딩 표시
	notificationCount: 0 //알림 갯수 표기
};
...
export const { activeItem, activeComponent, openDrawer, openComponentDrawer, openOnboarding, setNotiCount } = menu.actions;
